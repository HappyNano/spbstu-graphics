...
Text::Text(FT_Library & ft, const std::filesystem::path & font_path):
  _characters{}
{
  FT_Face face;
...
Text::~Text()
{
  for (auto & [c, character]: _characters)
  {
    glDeleteTextures(1, &character.TextureID);
  }
}

void Text::render(const Shader::shared & shader, const std::string & text, float x, float y, float scale, const glm::vec3 & color)
{
